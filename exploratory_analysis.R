...
library(ggplot2)
library(plyr)
library(tidyverse) # Is this needed?
library(DESeq2)
...
sampledata.df <- sampledata.df[order(sampledata.df$sampleNumber),]
...
ps.top100 <- prune_taxa(top100, ps)
...
#######################################
write.table(significantResults, file="DESeq_output.txt", quote=F, sep='\t', col.names=NA)
#######################################
